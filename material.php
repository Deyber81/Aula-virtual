...
$archivos=mysqli_query($con,("SELECT * FROM plan "));
$todosarchivos=mysqli_num_rows($archivos);
$numachivo=mysqli_fetch_assoc($archivos);
...
<section class="position-relative py-4 py-xl-5">
        <div class="container position-relative">
            <div class="row d-flex justify-content-center">
               ...
               if ($n>0){
                ...
                echo"<td><a class='btn btn-danger' href='material.php?id=".$aplan['idplan']."'>descargar actividad</a> </td></tr>";
                echo"<td><a class='btn btn-danger' href='material.php?ea=".$aplan['idplan']."'>eliminar actividad</a> </td></tr>";
                echo"<td><a class='btn btn-warning' href='material.php?ma=".$aplan['idplan']."'>editar actividad</a> </td></tr>";
                echo "<hr>";
    ...
    if ($n>0){
        ...
        echo"<td><a class='btn btn-primary' href='inicio.php?id=".$aplan['idplan']."'>Descargar Material</a> </td></tr>";
        echo "</article> ";
    }while($aplan=mysqli_fetch_assoc($queryplan));
